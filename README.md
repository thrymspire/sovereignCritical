...
```mermaid
graph TD
    classDef t1 fill:#22103c,stroke:#9d5cff,stroke-width:2px,color:#ede6ff;
    classDef t2 fill:#112a38,stroke:#5ffbf1,stroke-width:2px,color:#ede6ff;
    classDef t3 fill:#382810,stroke:#fbbf24,stroke-width:2px,color:#ede6ff;
    classDef t4 fill:#2d1445,stroke:#c084fc,stroke-width:2px,color:#ede6ff;
    classDef gate fill:#050208,stroke:#5ffbf1,stroke-width:3px,color:#5ffbf1;
    ...
    G2{<b>Rehab Payment #9 Gate</b><br/>March 28, 2027 &bull; Loan Cleared}:::gate

    T1 --> G1
    T3 --> G2

    G1 -->|Transcript Release| T4
    G1 -->|Prereq Unlocked| S27[<b>Spring 2027 Senior Standing</b><br/>13 Credits &bull; 94 Cr Cumulative]:::t1
    
    G2 -->|Credit Bureau Deletion| NSLDS[<b>Title IV Restored on NSLDS</b><br/>Default Removed Permanently]:::t3
    NSLDS -->|Unlock $29,580 Reserve| PELL[<b>Federal Pell Grant Activated</b><br/>Summer '27 / Fall '27 / Spring '28]:::t4
    NSLDS -->|Full-Time Status Lock-in| DEF[<b>In-School Deferment Mandate</b><br/>34 CFR § 682.210 &bull; $0 IDR Lock]:::t3

    T4 -->|Disbursements| BURSAR[<b>UAF Bursar Settlement</b><br/>In-State Distance Resident Rate $289/cr]:::t3

    S27 --> F27[<b>Fall 2027 Core Advancement</b><br/>13 Credits &bull; 107 Cr Cumulative]:::t1
    F27 --> SP28[<b>Spring 2028 Final Capstone</b><br/>13 Credits &bull; Degree Conferred]:::t1
    SP28 --> GRAD[<b>Saturday, May 6, 2028</b><br/>Commencement at Carlson Center]:::gate
    SP28 --> FELLOW[<b>Graduate School Horizon</b><br/>$15k-$37k/yr Post-Bacc Fellowships]:::t4
```
